...
# mut_cnv mut_exp exp_cnv
    ...
    for i in range(0, 10):
        ...
        print('==============================seed{}_{}================================='.format(seed, exp_params))
        ...
        # train
        metric_result, loss_val= net.train(train_set, val_set, **params)     

        # test
        torch.cuda.empty_cache()
        metric_test, loss_test = net.test(test_set)
        test_result_list.append(metric_test)
    test_dict[method]= test_result_list
